...
func TestMakeTuple(t *testing.T) {
	...
	tup2 := MakeTuple(I(1), Any(), F(3.14), S("Foo!"), Any())
	tup3 := MakeTuple(I(1), Any(), F(3.140001), S("Foo!"), Any())
	tup4 := MakeTuple(I(1), I(2), F(3.14), S("Foo!"), T(MakeTuple(Any())))
...
func TestElemOrdering(t *testing.T) {
	...
	tup1 := MakeTuple(I(1), Any(), F(3.14), S("Foo!"), Any())
	tup2 := MakeTuple(I(1), Any(), F(3.1400), S("Foo!"), Any())
	tup4 := MakeTuple(I(1), I(2), F(3.14), S("Foo!"), T(MakeTuple(Any())))
